...
contactSendBtn.addEventListener("click", function(){
      ...
      if (
        (contactName.value.trim() === "") || (contactEmail.value.trim() === "") || 
        (contactAdress.value.trim() === "") || (contactPhone.value.trim() === "") || 
        (contactTextarea.value.trim() === "") || (!emailPattern.test(contactEmail.value))
      ) {
